...
{
    private List<BehavioralDataWithTimer> _behavioralsWithTimers = new();
    private List<BehavioralData> _behaviorals = new();

    public static BehaviorUpdater Create(string name)
    {
        GameObject newGO = new GameObject(name);
        return newGO.AddComponent<BehaviorUpdater>();
    }
